const students = [
    { ID: 1, name: 'Alice', age: 21, grade: '9.8', degree: 'BE', email: 'alice@example.com' },
    { ID: 2, name: 'Bob', age: 22, grade: '9.1', degree: 'MBA', email: 'bob@example.com' },
    { ID: 3, name: 'Charlie', age: 20, grade: '9.8', degree: 'BTECH', email: 'charlie@example.com' }
  ];
